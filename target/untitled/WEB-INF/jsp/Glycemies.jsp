...
<div class="container mt-5">
    <form method="post" action="saveGlycemie" class="mb-5">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="idDiabete" name="idDiabete">
        </div>
    ...
    <div class="list-group">
        <c:forEach var="glycemie" items="${glycemies}">
            <div class="list-group-item">
                ...
                <h5 class="mb-1">ID Diabete: ${glycemie.idDiabete}</h5>
                <p class="mb-1">Valeur Before: ${glycemie.valeurBefore}</p>
